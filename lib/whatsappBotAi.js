...
- Si el usuario copia un mensaje de error técnico, extrae el errorMessage y usa intent=explicar_error.
...
function interpretHeuristic(text) {
  ...
  if (
    /error|fallo|falló|rechaz|invalid|codigo|código/i.test(lower) &&
    (normalized.length > 50 || /\{|\}|":|mensaje:/i.test(normalized))
  ) {
